 ...
 *
 * Run against staging:
 *   k6 run -e STAGING_URL=http://your-server:5000 tests/k6/auth-load.js
 */
...
// ---------------------------------------------------------------------------
// Error cases (separate scenario could be wired in; included here as a
// lightweight sanity check run once per VU at setup)
// ---------------------------------------------------------------------------
